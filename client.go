...
func (this *Client) Spot() *Spot {
	return NewSpot(this)
}

func (this *Client) Request(method string, path string, param UrlParam, ret any) (err error) {
	...
	if ok {
		...
		logf("http status-code: %d", resp.StatusCode)
		return
	}
	logf("%s", m)
	return
...
func (this *Client) Get(path string, param UrlParam, ret any) error {
	return this.Request(http.MethodGet, path, param, ret)
}

func (this *Client) Post(path string, param UrlParam, ret any) error {
	return this.Request(http.MethodPost, path, param, ret)
}

func (this *Client) Delete(path string, param UrlParam, ret any) error {
